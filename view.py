...
class View(object):
    ...
    def caricaInterfaccia(self):
        ...
        self._txtMmax = ft.TextField(label="Tot Tentativi", width=100, disabled=True, value=self._controller.getMmax())
        self._txtMrim = ft.TextField(label="Tentativi Rimanenti", width=100, disabled=True,
                                     value=self._controller.getMrim())
